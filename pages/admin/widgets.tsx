...
// core components
import CardsHeader from "../../argon/Headers/CardsHeader";
                    ...
                    <Row className="align-items-center">
                      <Col className="col-auto">
                        <a
                          ...
                          onClick={(e) => e.preventDefault()}
                        >
                          <img alt="..." src={"/assets/img/theme/team-5.jpg"} />
                        </a>
                      </Col>
                      <div className="col ml--2">
                        <h4 className="mb-0">
          ...
          <Col lg="4">
                    ...
                    <Row className="align-items-center">
                      <Col className="col-auto">
                        <a
                          ...
                          onClick={(e) => e.preventDefault()}
                        >
                          <img alt="..." src={"/assets/img/theme/sketch.jpg"} />
                        </a>
                      </Col>
                      <div className="col">
                    ...
                    <Row className="align-items-center">
                      <Col className="col-auto">
                        <a
                          ...
                          onClick={(e) => e.preventDefault()}
                        >
                          <img alt="..." src={"/assets/img/theme/vue.jpg"} />
                        </a>
                      </Col>
                      <div className="col">
            ...
            <Card>
              <CardBody>
                <Row className="justify-content-between align-items-center">
                  <div className="col">
                    <img alt="..." src={"/assets/img/icons/cards/paypal.png"} />
                  </div>
                  <Col className="col-auto">
          ...
          <Col lg="4">
              ...
              <CardBody>
                <ListGroup className="list my--3" flush>
                  <ListGroupItem className="px-0">
                    <Row className="align-items-center">
                      <Col className="col-auto">
                        <img alt="..." src={"/assets/img/icons/flags/US.png"} />
                      </Col>
                      <div className="col">
                        <small>Country:</small>
                  ...
                  <ListGroupItem className="px-0">
                    <Row className="align-items-center">
                      <Col className="col-auto">
                        <img alt="..." src={"/assets/img/icons/flags/DE.png"} />
                      </Col>
                      <div className="col">
                        <small>Country:</small>
                  ...
                  <ListGroupItem className="px-0">
                    <Row className="align-items-center">
                      <Col className="col-auto">
                        <img alt="..." src={"/assets/img/icons/flags/GB.png"} />
                      </Col>
                      <div className="col">
                        <small>Country:</small>
            ...
            <Card className="bg-gradient-primary">
              <CardBody>
                <Row className="justify-content-between align-items-center">
                  <div className="col">
                    <img alt="..." src={"/assets/img/icons/cards/visa.png"} />
                  </div>
                  <Col className="col-auto">
                    <Badge className="badge-lg" color="success">
                      Active
