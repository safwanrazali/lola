            ...
            <Card>
              ...
              <CardBody>
                <Row className="py-3 align-items-center">
                  ...
                  <Col sm="9">
                    <h1 className="mb-0">NextJS Argon Dashboard PRO</h1>
                  </Col>
                </Row>
                <Row className="py-3 align-items-center">
                  <Col sm="3">
                  ...
                  <Col sm="9">
                    <h2 className="mb-0">NextJS Argon Dashboard PRO</h2>
                  </Col>
                </Row>
                <Row className="py-3 align-items-center">
                  <Col sm="3">
                  ...
                  <Col sm="9">
                    <h3 className="mb-0">NextJS Argon Dashboard PRO</h3>
                  </Col>
                </Row>
                <Row className="py-3 align-items-center">
                  <Col sm="3">
                  ...
                  <Col sm="9">
                    <h4 className="mb-0">NextJS Argon Dashboard PRO</h4>
                  </Col>
                </Row>
                <Row className="py-3 align-items-center">
                  <Col sm="3">
                  ...
                  <Col sm="9">
                    <h5 className="mb-0">NextJS Argon Dashboard PRO</h5>
                  </Col>
                </Row>
                <Row className="py-3 align-items-center">
                  <Col sm="3">
                  ...
                  <Col sm="9">
                    <h6 className="mb-0">NextJS Argon Dashboard PRO</h6>
                  </Col>
                </Row>
              </CardBody>
            </Card>
            ...
            <Card>
              ...
              <CardBody>
                <Row className="py-3 align-items-center">
                  ...
                  <Col sm="9">
                    <h3 className="heading mb-0">NextJS Argon Dashboard PRO</h3>
                  </Col>
                </Row>
                <Row className="py-3 align-items-center">
                  <Col sm="3">
